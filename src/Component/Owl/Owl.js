...
// import backButtonImage from '../imges/Vector (1).png';
// import nextButtonImage from '../imges/Vector (2).png';
// import owl from '../imges/Group (2).png';
// import lefteye from '../imges/left-eye.png';
// import right from '../imges/right-eye.png';
...
//   const resetEyeRotation = () => {
//     setEyeRotation(0);
//     setIsBouncing(false); // Reset bouncing state when dragging ends
//   };
...
//         onAntInOwlEatArea={handleAntInOwlEatArea}
//       />
//       <div className='owl-container position-r'>
//         <div className='owl-eat'></div>
//         <img 
//           src={owl} 
//           className={`img-w ${isBouncing ? 'bounce' : ''}`} 
//           alt='owl' 
...
//           <img
//             src={lefteye}
//             className="position-ab-le"
//             alt='left-eye'
//             style={{ transform: `rotate(${eyeRotation}deg)` }}
//           />
//           <img
//             src={right}
//             className="position-ab-ri"
//             alt='right-eye'
//             style={{ transform: `rotate(${eyeRotation}deg)` }}
//           />
//         </div>
